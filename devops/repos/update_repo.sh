...
NO_HIPSYCL_PKG_BUILD=${NO_HIPSYCL_PKG_BUILD:-OFF}
...
[ "$HIPSYCL_PKG_BUILD_BASE" = "ON" ] && [ "$NO_HIPSYCL_PKG_BUILD" = "OFF" ] &&  \
bash $HIPSYCL_PKG_SCRIPT_DIR_ABS/rebuild-base-images.sh

[ "$HIPSYCL_PKG_BUILD_HIPSYCL" = "ON" ] && [ "$NO_HIPSYCL_PKG_BUILD" = "OFF" ] && \
