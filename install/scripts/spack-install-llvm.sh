...
. $SPACK_ROOT/share/spack/setup-env.sh
spack install llvm@11.0.0 cuda=False libcxx=False polly=False lldb=False lld=True internal_unwind=False gold=False target=x86_64 build_type=MinSizeRel -flang 
