...
CUDA_PKG=hipSYCL-cuda${HIPSYCL_PKG_NAME_SUFFIX}-${HIPSYCL_VERSION_STRING}
ROCM_PKG=hipSYCL-base-rocm${HIPSYCL_PKG_NAME_SUFFIX}-${HIPSYCL_VERSION_STRING}
COMMON_PKG=hipSYCL-base${HIPSYCL_PKG_NAME_SUFFIX}-${HIPSYCL_VERSION_STRING}
HIPSYCL_PKG=hipSYCL${HIPSYCL_PKG_NAME_SUFFIX}-${HIPSYCL_VERSION_STRING}
