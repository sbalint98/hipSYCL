...
export HIPSYCL_INSTALL_PREFIX=${HIPSYCL_INSTALL_PREFIX:-/home/sbalint/hipSYCL-installation}
...
HIPSYCL_WITH_ROCM=${HIPSYCL_WITH_ROCM:-OFF}
...
-DLLVM_DIR=/opt/hipSYCL/llvm/lib/cmake/llvm \
-DROCM_PATH=/opt/hipSYCL/rocm \
-DCUDA_TOOLKIT_ROOT_DIR=/opt/hipSYCL//cuda \
-DCLANG_EXECUTABLE_PATH=/opt/hipSYCL//llvm/bin/clang++ \
